...
//        self::STATUS_CHECKED => 'Đã kiểm hàng',
    ...
    public function fee(User $customer){
        ...
        return [
            ...
            'total_fee_vnd' => $buying_fee + $checking_fee + $shipping_china_vietnam_fee + $wood_crating_fee,
        ];
    }
