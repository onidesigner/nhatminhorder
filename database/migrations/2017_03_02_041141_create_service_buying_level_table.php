...
class CreateServiceBuyingLevelTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('service_buying_level', function (Blueprint $table) {
            $table->increments('id');
            $table->integer('level');
    ...
    {
        Schema::dropIfExists('service_buying_level');
    }
}
