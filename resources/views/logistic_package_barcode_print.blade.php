...
<div class="content" style="display: inline-block; width: 40%; float: left; margin-right: 5%;">
    <div style='
...
<div class="content" style="display: inline-block; width: 40%; float: left; margin-left: 5%">
    <div style='
                font-family: Helvetica Neue, Helvetica, Arial, San-Serif;
                font-weight: 500; display: inline-block; text-align: left; width: 100%; padding: 0 5px;'>
        {{$package->logistic_package_barcode}}
