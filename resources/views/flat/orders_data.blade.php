...
@if(count($orders))
    ...
    <div class="table-responsive">
        ...
        <table class="table-body-vertical-align-top table table-striped table-hover no-padding-leftright">
            <thead>
            <tr>

                <th width="20%">Đơn hàng</th>
                <th width="20%">Khách hàng</th>
                <th width="30%">Phí trên đơn</th>
                    ...
                    <td>
                        ...
                        <small>
                            @foreach($order->order_fee as $order_fee_item)
                                <div style="width: 50%; display: inline-block; float: left; margin-bottom: 10px;">
                                    <div style="">
