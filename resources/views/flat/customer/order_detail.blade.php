...
@section('content')
    <div id="order-detail-page" class="row-fluid">
        <div class="span12">
                        ...
                        <div class="tab-content">
                            ...
                            <div role="tabpanel" class="tab-pane active" id="home">
                                        ...
                                        <table class="table no-padding-leftright">
                                            ...
                                            {{--<tr>--}}
                                                {{--<td class="border-top-none">Mã: </td>--}}
                                                {{--<td class="border-top-none">--}}

                                                    {{--<h5 style="margin-top: 0;">{{$order->code}}</h5>--}}
                                                {{--</td>--}}
                                            {{--</tr>--}}


                                            <tr>
                                                <td class="border-top-none">Dịch vụ</td>
                                                <td class="border-top-none">
                                                    @if(!empty($services))
                                        ...
                                        <div class="row-fluid">
                                            <div class="span3">
                                                <a href="{{ str_replace('150x150', '600x600', $order_item->image)  }}" data-lightbox="image-1">
                                                    <img class="img-responsive" width="100%" src="{{$order_item->image}}" alt="">
                                                </a>
                                            </div>
                                            <div class="span9">
