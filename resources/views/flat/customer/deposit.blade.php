...
@section('content')
    ...
    <div class="row-fluid">
        <div class="span12">
            @include('flat/partials/cart-step', ['active' => 2])
        </div>
    </div>
                ...
                <div class="card-body">
                    <div class="row-fluid">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    <input required type="text" name="detail" class="form-control"
                                                           placeholder="Địa chỉ">

                                                </div>

                                                <div class="form-group">
                                                    <input required type="text" id="reciver_name" name="reciver_name"
                                                           class="form-control" placeholder="Tên người nhận">
                                                </div>


                                                <div class="form-group">
                                                    <input required type="text" name="reciver_phone"
                        ...
                        <div class="span6">
                            ...
                            <h4>Danh sách shop kết đơn ({{count($shops)}})</h4>
                            <br>
