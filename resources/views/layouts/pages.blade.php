...
<head>
    ...
    <link href="{{ asset('pages/assets/css/pages-icons.css') }}" rel="stylesheet" type="text/css">
    <link class="main-stylesheet" href="{{ asset('pages/assets/css/pages.css') }}" rel="stylesheet" type="text/css" />
    <!--[if lte IE 9]>
    <link href="{{ asset('pages/assets/plugins/codrops-dialogFx/dialog.ie.css') }}" rel="stylesheet" type="text/css" media="screen" />
    <![endif]-->
</head>
...
{{--<script src="{{ asset('pages/assets/plugins/jquery-bez/jquery.bez.min.js') }}"></script>--}}
...
{{--<script type="text/javascript" src="{{ asset('pages/assets/plugins/bootstrap-select2/select2.min.js') }}"></script>--}}
...
{{--<script src="{{ asset('pages/assets/plugins/mapplic/js/hammer.js') }}"></script>--}}
...
<script src="{{ asset('pages/assets/js/pages.min.js') }}"></script>
